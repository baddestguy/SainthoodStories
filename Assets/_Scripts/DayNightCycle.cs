...
public class DayNightCycle : MonoBehaviour
{
    ...
    private void OnTick(double time, int day)
    {
        switch (time)
        {
            ...
            case 2.5: TargetRotation = new Vector3(28,-30,0); TargetColor = new Color32(104, 222, 211, 255); break;
            case 3: TargetRotation = new Vector3(32.5f,-30,0); TargetColor = new Color32(104, 222, 211, 255); break;
            case 3.5: TargetRotation = new Vector3(36f,-30,0); TargetColor = new Color32(104, 222, 211, 255); break;
            ...
            case 12.5: TargetRotation = new Vector3(93,-30,0); TargetColor = new Color32(255, 255, 255, 255); break;
            case 13: TargetRotation = new Vector3(96.6f,-30,0); TargetColor = new Color32(255, 255, 255, 255); break;
            case 13.5: TargetRotation = new Vector3(99f,-30,0); TargetColor = new Color32(255, 255, 255, 255); break;
            ...
            case 23.5: TargetRotation = new Vector3(162,-30,0); TargetColor = new Color32(104, 222, 211, 255); break;
        }
    }
